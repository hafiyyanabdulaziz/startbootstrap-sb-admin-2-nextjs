        ...
        <div id='content-wrapper' className='d-flex flex-column'>
          ...
          <div id='content'>
                  ...
                  <div
                    ...
                    <a
                      ...
                      <div>
                        ...
                        Spending Alert: Weve noticed unusually high spending for
                        your account.
                      </div>
                    </a>
                    <a
                  ...
                  <div
                    ...
                    <a
                      ...
                      <div className='dropdown-list-image mr-3'>
                        <img
                          ...
                          src='startbootstrap-sb-admin-2/img/undraw_profile_1.svg'
                          alt='...'
                        />
                    ...
                    <a
                      ...
                      <div className='dropdown-list-image mr-3'>
                        <img
                          className='rounded-circle'
                          src='startbootstrap-sb-admin-2/img/undraw_profile_2.svg'
                          alt='...'
                        />
                    ...
                    <a
                      ...
                      <div className='dropdown-list-image mr-3'>
                        <img
                          className='rounded-circle'
                          src='startbootstrap-sb-admin-2/img/undraw_profile_3.svg'
                          alt='...'
                        />
                      ...
                      <div>
                        <div className='text-truncate'>
                          Last months report looks great, I am very happy with
            ...
            <div className='container-fluid'>
              ...
              <p className='mb-4'>
                Bootstraps default utility classes can be found on the official{" "}
                <a href='https://getbootstrap.com/docs'>
                  Bootstrap Documentation
                </a>{" "}
                page. The custom utilities below were created to extend this
                theme past the default utility classes built into Bootstraps
                framework.
              </p>
              {/* Content Row */}
              <div className='row'>
